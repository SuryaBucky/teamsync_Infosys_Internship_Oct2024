...
const { validateTaskCreation, createTask,viewTasksByProject,validateAddAssignee,addAssignee,validateUpdateDeadline,updatedeadline,validateEditDetails,editTaskDetails } = require('../middlewares/TaskMiddlewares'); 
